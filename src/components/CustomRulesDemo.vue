  ...
  <div class="space-y-6">
    <div class="card">
      ...
      <p class="text-gray-600 mb-4">
        在
        <code class="bg-gray-100 px-2 py-0.5 rounded text-sm">uno.config.ts</code>
        中定义自定义规则， 用正则匹配生成任意 CSS 属性，扩展 UnoCSS 的能力。
      </p>
    ...
    <div class="card">
      ...
      <div class="space-y-4">
        <div class="text-2xl font-bold text-gray-800 text-shadow">text-shadow（默认阴影）</div>
        <div class="text-2xl font-bold text-gray-800 text-shadow-sm">text-shadow-sm（小阴影）</div>
        <div class="text-2xl font-bold text-gray-800 text-shadow-lg">text-shadow-lg（大阴影）</div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="flex flex-wrap gap-3 mb-4">
        <div
          class="w-20 h-20 bg-brand rounded-xl flex items-center justify-center text-white text-xs font-bold"
        >
          brand
        </div>
        <div
          class="w-20 h-20 bg-brand-light rounded-xl flex items-center justify-center text-white text-xs font-bold"
        >
          light
        </div>
        <div
          class="w-20 h-20 bg-brand-dark rounded-xl flex items-center justify-center text-white text-xs font-bold"
        >
          dark
        </div>
      </div>
    ...
    <div class="card">
      ...
      <div class="space-y-4">
        ...
        <div class="relative h-32 rounded-xl overflow-hidden">
          ...
          <div
            class="absolute inset-4 bg-white/20 backdrop-blur-md rounded-lg border border-white/30 flex items-center justify-center text-white font-bold text-lg"
          >
        ...
        <!-- 渐变文字 -->
        <div
          class="text-3xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent"
        >
        ...
        <p class="text-gray-600 truncate">
          这是一段很长的文字，使用 truncate
          工具类可以自动截断并显示省略号，非常适合列表标题或卡片描述等场景。
        </p>
    ...
    <div class="card">
      ...
      <div class="flex flex-wrap gap-2">
        <span
          v-for="color in ['red', 'blue', 'green', 'purple', 'orange']"
          :key="color"
          :class="[

  ...
  <div class="space-y-6">
    ...
    <div class="card">
      ...
      <div class="flex flex-wrap gap-4">
        <div class="w-24 h-24 bg-blue-500 rounded-xl transition-all duration-300 hover:scale-110 hover:rotate-12 hover:bg-purple-500 hover:shadow-2xl cursor-pointer flex items-center justify-center text-white text-sm font-bold">
          hover me
        </div>
        <div class="w-24 h-24 bg-green-500 rounded-xl transition-transform duration-500 hover:-translate-y-4 hover:shadow-xl cursor-pointer flex items-center justify-center text-white text-sm font-bold">
          上浮
        </div>
        <div class="w-24 h-24 bg-red-500 rounded-full transition-all duration-300 hover:rounded-xl cursor-pointer flex items-center justify-center text-white text-sm font-bold">
          形变
        </div>
        <div class="w-24 h-24 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl transition-all duration-300 hover:bg-gradient-to-l cursor-pointer flex items-center justify-center text-white text-sm font-bold">
          渐变翻转
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div v-if="isLoading" class="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
        <div class="w-5 h-5 border-3 border-blue-500 border-t-transparent rounded-full animate-spin" />
    ...
    <div class="card bg-amber-50 border-amber-200">
      ...
      <ul class="space-y-1 text-amber-700 text-sm">
        <li>• <code class="bg-amber-200 px-1 rounded">transition-all duration-300</code> — 所有属性过渡，300ms</li>
        <li>• <code class="bg-amber-200 px-1 rounded">hover:scale-110</code> — 悬停放大 110%</li>
        <li>• <code class="bg-amber-200 px-1 rounded">animate-spin/ping/pulse/bounce</code> — 内置动画</li>
        <li>• Vue <code class="bg-amber-200 px-1 rounded">&lt;Transition&gt;</code> 配合 UnoCSS class 实现入场/出场动画</li>
        <li>• 用 <code class="bg-amber-200 px-1 rounded">ease-in/ease-out/ease-in-out</code> 控制缓动曲线</li>
      </ul>
    </div>
  </div>
</template>
